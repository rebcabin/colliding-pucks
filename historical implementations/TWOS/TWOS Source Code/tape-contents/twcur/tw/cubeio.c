...
/*
 * $Log:	cubeio.c,v $
 * Revision 1.21  92/02/25  10:50:03  configtw
 * Changed to version 2.7.1
 * 
 * Revision 1.20  91/12/31  08:26:16  configtw
 * New version ID.
 * 
 * Revision 1.19  91/12/27  09:04:54  pls
 * 1.  Add support for address table length stats (SCR 214).
 * 2.  Fix up TIMING code.
 * 
